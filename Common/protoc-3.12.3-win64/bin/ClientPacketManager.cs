...
class PacketManager
{
	...
	{		
		...
		_onRecv.Add((ushort)MsgId.SJobChoice, MakePacket<S_JobChoice>);
		_handler.Add((ushort)MsgId.SJobChoice, PacketHandler.S_JobChoiceHandler);		
		...
		_onRecv.Add((ushort)MsgId.SMovePlayer, MakePacket<S_MovePlayer>);
		_handler.Add((ushort)MsgId.SMovePlayer, PacketHandler.S_MovePlayerHandler);		
		_onRecv.Add((ushort)MsgId.SJumpPlayer, MakePacket<S_JumpPlayer>);
		_handler.Add((ushort)MsgId.SJumpPlayer, PacketHandler.S_JumpPlayerHandler);		
		_onRecv.Add((ushort)MsgId.SAttackPlayer, MakePacket<S_AttackPlayer>);
		_handler.Add((ushort)MsgId.SAttackPlayer, PacketHandler.S_AttackPlayerHandler);		
		...
		_onRecv.Add((ushort)MsgId.SMoveProjectile, MakePacket<S_MoveProjectile>);
		_handler.Add((ushort)MsgId.SMoveProjectile, PacketHandler.S_MoveProjectileHandler);		
		_onRecv.Add((ushort)MsgId.SDespawnProjectile, MakePacket<S_DespawnProjectile>);
		_handler.Add((ushort)MsgId.SDespawnProjectile, PacketHandler.S_DespawnProjectileHandler);
	}
